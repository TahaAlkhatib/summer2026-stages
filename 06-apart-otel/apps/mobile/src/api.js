...
// Android emulatorunde bilgisayarin adresi 10.0.2.2 olur.
// Gercek telefonda bilgisayarinizin yerel IP adresini yazin.
...
async function istek(yol, ayarlar = {}) {
  ...
  // Sunucu kapaliysa fetch cok uzun bekleyebiliyor, sure siniri koyuyoruz
